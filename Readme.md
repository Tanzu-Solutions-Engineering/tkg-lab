...
3. [One Step Scripted Deployment for Azure](docs/baseline-lab-setup/one-step-azure.md) - This method assumes you have done any required manual steps.  There is one script that will deploy all clusters and perform integrations.  It is best to use this after you have already completed the step by step guide, as any specific configuration issue you may would have been worked out in that process previously.
4. [One Step Scripted Deployment for vSphere](docs/baseline-lab-setup/one-step-vsphere.md) - This method assumes you have done any required manual steps.  There is one script that will deploy all clusters and perform integrations.  It is best to use this after you have already completed the step by step guide, as any specific configuration issue you may would have been worked out in that process previously.
5. [Helm Install Step by Step Guide](./helm-install/README.md) - If you want to go down the path of using helm charts for all cluster extensions, Please follow below url and come back to complete lab. Helm install gives you Management Cluster, Shared Services Clusters and Workload clusters with all extensions for both AWS and vSphere.
