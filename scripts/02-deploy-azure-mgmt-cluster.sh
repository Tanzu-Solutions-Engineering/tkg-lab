...
export AZURE_RESOURCE_GROUP="$AZURE_APP_NAME"
...
export AZURE_VNET_RESOURCE_GROUP="$AZURE_APP_NAME"
...
yq e -i '.AZURE_RESOURCE_GROUP = env(AZURE_RESOURCE_GROUP)' "$CLUSTER_CONFIG"
...
yq e -i '.AZURE_VNET_RESOURCE_GROUP = env(AZURE_RESOURCE_GROUP)' "$CLUSTER_CONFIG"
