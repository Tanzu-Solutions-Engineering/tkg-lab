...
cp config-templates/aws-cluster-config.yaml generated/$CLUSTER_NAME/cluster-config.yaml
...
tanzu management-cluster create --file=generated/$CLUSTER_NAME/cluster-config.yaml -v 6
