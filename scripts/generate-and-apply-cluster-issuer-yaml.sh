...
then
  echo "DNS Provider is gcloud-dns.  Use DNS resolver for cluster issuer."
...
then
  echo "DNS Provider is azure-dns.  Use DNS resolver for cluster issuer."
  # Using Azure DNS
  ...
  echo "DNS Provider is route-53.  Use DNS resolver for cluster issuer."
  # Using Route53
