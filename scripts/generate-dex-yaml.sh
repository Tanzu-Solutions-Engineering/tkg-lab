...
# Following environment variables are required: DEX_CN, GANGWAY_CN, OCTA_ISSUER_URL, OCTA_DEX_APP_CLIENT_ID, OCTA_DEX_APP_CLIENT_SECRET
...
sed -i '' -e 's/$OCTA_ISSUER_URL/'$OCTA_ISSUER_URL'/g' clusters/mgmt/tkg-extensions-mods/authentication/dex/aws/oidc/generated/sensitive/04-cm.yaml
