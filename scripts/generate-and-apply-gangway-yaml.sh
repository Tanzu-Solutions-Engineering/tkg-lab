...
# 02b-ingress.yaml
yq read $DIR/../tkg-extensions-mods-examples/authentication/gangway/aws/02b-ingress.yaml > generated/$CLUSTER_NAME/gangway/02b-ingress.yaml
yq write -d0 generated/$CLUSTER_NAME/gangway/02b-ingress.yaml -i "spec.virtualhost.fqdn" $GANGWAY_CN

# 03-config.yaml
yq read $DIR/../tkg-extensions-mods-examples/authentication/gangway/aws/03-config.yaml > generated/$CLUSTER_NAME/gangway/03-config.yaml
if [ `uname -s` = 'Darwin' ]; 
then
...
# 05-certs.yaml
yq read $DIR/../tkg-extensions-mods-examples/authentication/gangway/aws/05-certs.yaml > generated/$CLUSTER_NAME/gangway/05-certs.yaml
