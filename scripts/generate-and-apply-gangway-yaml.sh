...
kubectl create configmap gangway-overlay --from-file=gangway-overlay.yaml=tkg-extensions-mods-examples/authentication/gangway/aws/gangway-overlay.yaml -n tanzu-system-auth -o yaml --dry-run=client | kubectl apply -f-

kubectl apply -f tkg-extensions-mods-examples/authentication/gangway/aws/gangway-extension.yaml
